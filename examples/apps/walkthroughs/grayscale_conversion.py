...
def main():
    ...
    sampled_frames = cl.streams.Stride(frames, [2]) # Select every third frame
    ...
    output_stream = sp.NamedVideoStream(cl, 'sample-clip-grayscale')
    ...
    output_stream.save_mp4('sample-clip-grayscale')
