...
.. raw:: html
  ...
  <div class="row">
    <div class="col-md-6 col-xs-12">
      <h3>
       Simplified and scalable video processing
      </h3>
      <ul>
        <li><b>Out-of-the box modules:</b> For object, pose, face detection, and more.</li>
        <li><b>Directly access video files:</b> no more pre-processing into images!</li>
        <li><b>Efficient:</b> maximize uss of many-core CPUs and GPU accelerators.</li>
        <li><b>Scalable:</b> scale out to hundreds of machines in the cloud or your local cluster.</li>
        <li><b>Cloud integration:</b> integrated with Kubernetes, Google Cloud Platform, and AWS.</li>
      </p>
    </div>
