...
const std::string &Evaluator::get_name() const { return name_; }

const std::vector<EvalInput> &Evaluator::get_inputs() const { return inputs_; }

DeviceType Evaluator::get_device_type() const { return type_; }

char *Evaluator::get_args() const { return args_; }

size_t Evaluator::get_args_size() const { return args_size_; }

Evaluator *EvalInput::get_evaluator() const { return evaluator; }
