...
class SqueezeNetInputEvaluator : public Evaluator {
 public:
 ...
 private:
  ...
  static const i32 NET_INPUT_HEIGHT = 227;
...
class SqueezeNetInputEvaluatorFactory : public EvaluatorFactory {
 public:
  SqueezeNetInputEvaluatorFactory(DeviceType device_type,
