...
class CPMPersonInputEvaluator : public Evaluator {
 public:
  CPMPersonInputEvaluator(DeviceType device_type, i32 device_id,
...
class CPMPersonInputEvaluatorFactory : public EvaluatorFactory {
 public:
  CPMPersonInputEvaluatorFactory(DeviceType device_type,
